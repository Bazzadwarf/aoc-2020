...
void Part2::ParseMask(std::string s)
{
...
void Part2::ParseMem(std::string inst, std::string value)
{
...
void Part2::CalculatePermutations(std::vector<std::bitset<36>>* permutations)
{
	return;
}
